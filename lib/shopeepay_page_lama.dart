...
class ShopeediaPayPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("ShopeediaPay", style: TextStyle(fontWeight: FontWeight.bold)),
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    _buildMenuButton(Icons.receipt_long, "Minta"),
                  ],
                ),
              ],
            ),
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                _buildTransactionItem("Transfer ke BCA", "- Rp 500.000", "Hari ini", Colors.black),
                _buildTransactionItem("Pembayaran ShopeeFood", "- Rp 45.000", "Kemarin", Colors.black),
                _buildTransactionItem("Top Up dari BRI", "+ Rp 1.000.000", "14 Des 2024", Colors.green),
                _buildTransactionItem("Terima Dana dari Budi", "+ Rp 50.000", "12 Des 2024", Colors.green),
                _buildTransactionItem("Beli Pulsa", "- Rp 25.000", "10 Des 2024", Colors.black),
              ],
            ),
          ),
        ],
